...
pub fn day_03_v1(input: &str) -> u32 {
  ...
  return houses.len() as u32;
}

pub fn day_03_v2(input: &str) -> u32 {
  let mut santa: (i8, i8) = (0, 0);
...
mod tests {
  ...
  fn works_with_samples_v1() {
    let sample_one: [(&str, u32); 3] = [(">", 2), ("^>v<", 4), ("^v^v^v^v^v", 2)];
  ...
  fn works_with_samples_v2() {
    let sample_two: [(&str, u32); 3] = [("^v", 3), ("^>v<", 3), ("^v^v^v^v^v", 11)];
